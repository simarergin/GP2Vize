    ...
    public class NhibernateHelper
    {
        ...
        private static ISessionFactory SessionFactory
        {
            get
            {
                if (_sessionFactory == null)
                {
                    ...
                    configuration.AddDeserializedMapping(mapping, "ödevdb");
        ...
        public static void Setup()
        {
            ...
            try
            {
                ...
                var mapping = GetMappings();
                NhConfiguration.AddDeserializedMapping(mapping, "ödevdb");
        ...
        {
            //log.Warn("Check DB");
            if (System.IO.File.Exists(exctLcl + "\\ödevdb.db")) return;
            SQLiteConnection.CreateFile(exctLcl + "\\ödevdb.db");
            using (var cn = new SQLiteConnection("Data Source=" + exctLcl + "\\ödevdb.db;Version=3;Password=;PRAGMA journal_mode=WAL;"))
            {
        ...
        public static Configuration ConfigureNhibernate()
        {
            ...
            configure.DataBaseIntegration(db =>
            {
                ...
                db.ConnectionString = "Data Source=" + exctLcl + "//ödevdb.db;Version=3;PRAGMA journal_mode=WAL;";
            });
        ...
        protected static HbmMapping GetMappings()
        {
            ...
            mapper.AddMapping<Model.FilmMap>();
            mapper.AddMapping<Model.SeansMap>();
            mapper.AddMapping<Model.SalonMap>();
